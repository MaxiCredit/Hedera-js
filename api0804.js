...
*/
    ...
    backToOffers.setAttribute("onclick", "backToOffersFx()");
...
function listOffersToTable(data, url, amount) {
    ...
    for(var a = 0; a < data.length; a++) {
        if(data[a].amount > 1999 && data[a].amount >= amount) {
            ...
            newUl.innerHTML = "<li>" + data[a].amount + "</li><li>" + data[a].length / 86400 + "nap</li><li>" + data[a].periods + "</li><li>" + data[a].interest / 10 + "</li><li>" + data[a].score + "</li>";
            ...
            newUl.setAttribute("onclick", "getOfferDetails()");
...
function backToOffersFx() {
    closeModal();
    createModal("listOffers", "");
}
